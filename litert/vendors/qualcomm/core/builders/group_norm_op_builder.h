...
#ifndef ODML_LITERT_LITERT_VENDORS_QUALCOMM_CORE_BUILDERS_GROUP_NORM_OP_BUILDER_H_
#define ODML_LITERT_LITERT_VENDORS_QUALCOMM_CORE_BUILDERS_GROUP_NORM_OP_BUILDER_H_
