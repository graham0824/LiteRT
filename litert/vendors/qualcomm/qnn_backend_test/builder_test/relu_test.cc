...
TEST_P(QnnModelTest, SingleRelu) {
  ...
  CreateInputTensorWithSuffix(input_0, "input_0", QNN_DATATYPE_FLOAT_32, {},
                              kDims, "");
  ::qnn::TensorWrapper output_0;
  CreateOutpuTensorWithSuffix(output_0, "output_0", QNN_DATATYPE_FLOAT_32, {},
                              kDims, "");
  auto ops = ::qnn::BuildReluOp({input_0}, {output_0});
